...
<!--PROGRESS:START-->
**15 solved** · 13 Easy · 2 Medium · 0 Hard
<!--PROGRESS:END-->
...
| 258 | [Add Digits](0258-add-digits/) | Easy | Java |  |
...
| 3898 | [Find the Degree of Each Vertex](3898-find-the-degree-of-each-vertex/) | Easy | Java |  |
...
Each problem lives in its own folder `NNNN-slug/`, containing:
- The solution file (`.java` for Java, `.py` for Python)
...
```bash
javac 0001-two-sum/0001-two-sum.java
java Solution
```
