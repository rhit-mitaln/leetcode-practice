...
Brute force: for each element, scan the rest of the array for a value that sums to the target.

- **Time:** O(n²)
- **Space:** O(1)

**Follow-up:** can be done in O(n) time with a hash map — store `target - num` as you go.
